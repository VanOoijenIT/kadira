...
Package.on_test(function (api) {
  ...
  // common after
  api.add_files(
    ["tests/common/default_error_filters.js", "tests/common/send.js"],
    ["client", "server"]
  );
});
...
function configurePackage(api) {
  ...
  api.use(["underscore", "random", "fetch", "localstorage"], ["client"]);

  // common before
  api.add_files(
    ["lib/common/unify.js", "lib/models/base_error.js"],
    ["client", "server"]
  );
  ...
  // common after
  api.add_files(
    ["lib/common/default_error_filters.js", "lib/common/send.js"],
    ["client", "server"]
  );
}
